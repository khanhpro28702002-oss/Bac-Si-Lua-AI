...
DATA_BENH = {
    "Bacterial Leaf Blight": {
        "ten": "BỆNH BẠC LÁ",
        "trieu_chung": "Vết bệnh lan dọc mép lá từ chóp xuống, màu vàng xám.",
        "nguyen_nhan": "Vi khuẩn Xanthomonas oryzae. Thừa đạm, mưa bão.",
        "thuoc": ["Starner 20WP", "Xanthomix 20WP"],
        "loi_khuyen": "Ngưng bón đạm, bón Kali.",
        "icon": "🦠"
    },
    "Blast": {
        "ten": "BỆNH ĐẠO ÔN",
        "trieu_chung": "Vết hình mắt én, tâm xám, viền nâu đậm.",
        "nguyen_nhan": "Nấm Pyricularia oryzae. Độ ẩm cao.",
        "thuoc": ["Beam 75WP", "Fuji-one 40EC"],
        "loi_khuyen": "Giữ nước ruộng ổn định.",
        "icon": "🔥"
    },
    "Brown Spot": {
        "ten": "BỆNH ĐỐM NÂU",
        "trieu_chung": "Vết tròn nâu như hạt mè.",
        "nguyen_nhan": "Nấm. Thiếu dinh dưỡng.",
        "thuoc": ["Tilt Super 300EC"],
        "loi_khuyen": "Bón cân đối N-P-K.",
        "icon": "🍂"
    }
}
DATA_BENH.update({
...
if loc and 'coords' in loc:
    ...
    if weather:
        ...
        c1.metric("🌡️", f"{weather['temperature_2m']}°C")
        c2.metric("💧", f"{weather['relative_humidity_2m']}%")
        c3.metric("🌧️", f"{weather['rain']}mm")

st.markdown("---")

tab1, tab2 = st.tabs(["🔍 CHẨN ĐOÁN", "📋 LỊCH SỬ"])
